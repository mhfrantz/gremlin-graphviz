...
module.exports = Q.promised(function (gremlinGraph, opts) {
  ...
  var addVertexSideEffect = makeSideEffect(gremlin, gremlin.wrapVertex.bind(gremlin), function (vertex) {
    addVertex(graphvizGraph, vertex);
  });

  var Direction = gremlin.java.import('com.tinkerpop.gremlin.structure.Direction');

  var addEdgeSideEffect = makeSideEffect(gremlin, gremlin.wrapEdge.bind(gremlin), function (edge) {
